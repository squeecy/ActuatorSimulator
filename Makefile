...
compile:
	g++ -static -I src/include -I $(IMGUI_DIR) \
	    ...
	    src/RungeKutta.cpp src/pid.cpp src/interact_var.cpp src/gui/gui.cpp \
...
link:
	g++ main.o aircraft.o simvar.o hydraulics.o structure.o render.o interp.o user.o RungeKutta.o pid.o interact_var.o gui.o imgui.o imgui_draw.o imgui_tables.o imgui_widgets.o imgui-SFML.o  \
