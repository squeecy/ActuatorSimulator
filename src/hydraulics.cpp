...
namespace MsfsAeroFramework {
  ...
  void DC10HydraulicEnginePumpSystem::findDarcyFriction() {
    ...
    this->Re = (4.0 * (*fe_eng_primary_pump_flow_member)->current_value) /
  ...
  void DC10HydraulicEnginePumpSystem::systemDeltaP() {
    ...
    double V = this->GPM2VEL((*fe_eng_primary_pump_flow_member)->current_value,
                             this->D_pipe);
    this->dt = dt;
  ...
  void DC10HydraulicEnginePumpSystem::systemPressure() {
    ...
    if (this->f != 0.0) {
      ...
      this->flowFactor = (*fe_eng_primary_pump_flow_member)->current_value /
                         (sqrt(abs(this->deltaP)));
      this->hydraulic_pressure +=
          ((((*fe_eng_primary_pump_flow_member)->current_value * 9.27) / 50.27));
    } else {
      this->flowFactor = 0.0;
  ...
  void DC10HydraulicEnginePumpSystem::check_pump_operation() {
    ...
    if(this->pump_id != 4 && this->pump_id != 5)
    {
  ...
  void DC10HydraulicEnginePumpSystem::check_pump_dissipate() {
    ...
    if (this->pump_id != 3 && this->pump_id != 4 && this->pump_id != 5) {
      this->dissipating =
  ...
  void DC10HydraulicEnginePumpSystem::assign_member() {
    ...
    case FIRST_FIRST:
      ...
      fe_aux_operating_member = &this->fe_aux_1_operation;
    ...
    case THIRD_FIRST:
      ...
      //change to include both aux systems
      fe_aux_operating_member = &this->fe_aux_1_operation;
        
      this->aux_line_1_pressure = fe_hydro_pressure_aux_1->current_value;
      break;
    case THIRD_SECOND:
      fe_hydraulic_pressure_member = &this->fe_hydro_pressure_3;
      ...
      break;
    case AUX_ONE:
      fe_hydraulic_pressure_member = &this->fe_hydro_pressure_aux_1;
      ...
      fe_hydro_line_operation_member = &this->fe_aux_1_operation;
      fe_hydro_line_opposite_operation_member = &this->fe_aux_2_operation;
      fe_eng_primary_pump_flow_member = &this->fe_aux_pump_flow_1;
      fe_eng_secondary_pump_flow_member = &this->fe_aux_pump_flow_2;
      fe_system_hydro_flow_member = &this->fe_hydro_flow_3;
      fe_aux_operating_member = &this->fe_aux_1_operation;
      fe_rmp_partner_1_system_member = &this->fe_hydro_pressure_1;
      fe_rmp_partner_2_system_member = &this->fe_hydro_pressure_2;
      this->secondary_pump = fe_line_hydro_pressure_aux_2->current_value;
      this->rmp_switch_position_combo =
          fe_rmp_13_operation->current_value + fe_rmp_23_operation->current_value;
      break;
    case AUX_TWO:
      fe_hydraulic_pressure_member = &this->fe_hydro_pressure_aux_1;
      fe_eng_1_pump_pressure_member = &this->fe_line_hydro_pressure_aux_2;
      fe_eng_2_pump_pressure_member = &this->fe_line_hydro_pressure_aux_1;
      fe_hydro_line_operation_member = &this->fe_aux_2_operation;
      fe_hydro_line_opposite_operation_member = &this->fe_aux_1_operation;
      fe_eng_primary_pump_flow_member = &this->fe_aux_pump_flow_2;
      fe_eng_secondary_pump_flow_member = &this->fe_aux_pump_flow_1;
      fe_system_hydro_flow_member = &this->fe_hydro_flow_3;
      fe_aux_operating_member = &this->fe_aux_2_operation;
      fe_rmp_partner_1_system_member = &this->fe_hydro_pressure_1;
      fe_rmp_partner_2_system_member = &this->fe_hydro_pressure_2;
      this->secondary_pump = fe_line_hydro_pressure_aux_1->current_value;
      this->rmp_switch_position_combo =
          fe_rmp_13_operation->current_value + fe_rmp_23_operation->current_value;
      break;
  ...
  void DC10HydraulicEnginePumpSystem::make_members_current() {
    ...
    //clamp hydro pressure greater than 0
    ...
    if(this->pump_id != 3)
    {
      ...
      (*fe_hydraulic_pressure_member)->current_value =
          std::max(std::max((*fe_eng_1_pump_pressure_member)->current_value, this->secondary_pump),
                   std::max(fe_line_hydro_pressure_aux_2->current_value, fe_line_hydro_pressure_aux_1->current_value))
        /100.0;
  ...
  void DC10ActuatorSystem::actuator_valve_displacement(double delta_time) {
    ...
    system_1.fe_line_hydro_pressure_1_1->current_value -= ((((total_volume_to_reservoir * 100.0) * 9.27) / 50.27));
  }
...
#define SWITCH_AUTO 2
  ...
  void DC10ReversibleMotorPump::assign_member() {
    ...
    this->eng_switch_positions = fe_eng_1_hyd_pump_1_switch->current_value +
                                 ...
                                 fe_aux_hyd_pump_1_switch->current_value +
                                 fe_aux_hyd_pump_2_switch->current_value;
    switch (this->switch_id) {
    case 1:
  ...
  void DC10ReversibleMotorPump::check_rmp_state(Pump_State &state) {
    ...
    int sys_3_operating =
        ...
        this->system_aux_line_1.operating + this->system_aux_line_2.operating;
    ...
    int hydro_operation =
        ...
        line_aux_1_operation->current_value + line_aux_2_operation->current_value;
    std::cout << hydro_operation << std::endl;
...
#define SWITCH_AUTO 1
    ...
    double slave_hydraulic_pressure = slave_hydro_line_1.hydraulic_pressure + slave_hydro_line_2.hydraulic_pressure;
    double system_3_hydraulic_pressure = system_3_left_line.hydraulic_pressure + 
                                         system_3_right_line.hydraulic_pressure +
                                         system_aux_line_1.hydraulic_pressure +
                                         system_aux_line_2.hydraulic_pressure;
    ...
    case SWITCH_ON:
      ...
      if (switch_id == 2) {
        if (this->slave_hydro_line_1.operating + this->slave_hydro_line_2.operating == 0 &&
            slave_hydraulic_pressure + system_3_hydraulic_pressure > 0.0 &&
  ...
  void DC10ReversibleMotorPump::simulate_pressure_exchange(double delta_time) {
    ...
    double pressure_delta =
        std::abs((std::max(
        std::max(this->system_3_left_line.hydraulic_pressure, this->system_3_right_line.hydraulic_pressure), 
        std::max(this->system_aux_line_1.hydraulic_pressure, this->system_aux_line_2.hydraulic_pressure)))
                 -slave_pressure);
    ...
    if (this->operating) {
      ...
      system_3_left_line.hydraulic_pressure -= (this->pressure_change * rmp_valve);
      system_3_right_line.hydraulic_pressure -= (this->pressure_change) * rmp_valve;
      system_aux_line_1.hydraulic_pressure -= (this->pressure_change) * rmp_valve;
      system_aux_line_2.hydraulic_pressure -= (this->pressure_change) * rmp_valve;
  ...
  void DC10HydraulicAuxPumpSystem::elec_motor(double delta_time)
  {
    ...
    this->e_rpm = 60.0 * P_mech_work / ((2*M_PI) * 1.2);
  ...
  void DC10HydraulicAuxPumpSystem::elec_pump(double delta_time)
  {
    ...
    if(this->operating)
    {
      elec_motor(delta_time);
      (*fe_aux_motor_rpm_member)->current_value = this->e_rpm;
    }
  }
  ...
  void DC10HydraulicAuxPumpSystem::check_motor_operation()
  {
    ...
    switch (enginePumpSystem->pump_id) {
      case 4:
    ...
    (*fe_aux_operating_member)->current_value = this->operating;
  }
  ...
  void DC10HydraulicAuxPumpSystem::assign_member()
  {
    ...
    enginePumpSystem->operating = this->operating;
  }
  ...
  void DC10HydraulicEnginePump::update(double delta_time) {
    ...
    //aux pump
    this->aux_pump_1.update(delta_time);
    this->aux_pump_2.update(delta_time);
    ...
    this->auxiliary_pump_1.update(delta_time);
    this->auxiliary_pump_2.update(delta_time);
  }
